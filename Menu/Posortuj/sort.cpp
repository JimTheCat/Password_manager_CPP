...
void sort::sorting(std::vector<std::vector<std::string>>& vec) {
    int choice = 0;
    int index = 1;
    ...
    switch (choice) {
        case 1:{
            ...
            std::cin >> parameter;
            parameter--;
            std::sort(vec.begin(), vec.end(), [parameter](const std::vector<std::string>& a, const std::vector<std::string>& b){
        ...
        case 2:{
            ...
            firstParameter--;
            secondParameter--;
            std::sort(vec.begin(), vec.end(), [firstParameter, secondParameter](const std::vector<std::string>& a, const std::vector<std::string>& b){
        ...
        default: std::cerr << "void sorting(): Podano nieprawidlowy argument!" << std::endl;
    }
}
